...
const ProductHeroSlider: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-96 md:h-[500px] bg-gradient-to-r from-gray-50 to-white overflow-hidden">
      {/* Main Slider Content */}
      ...
      {/* Slide Indicator */}
      <div className="absolute top-6 right-6 bg-black/20 text-white px-3 py-1 rounded-full text-sm">
